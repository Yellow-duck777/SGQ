...
namespace SGQ.Web.Migrations
{
    ...
    [Migration("20260909002722_AddNaoConformidades")]
    partial class AddNaoConformidades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGQ.Web.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SGQ.Web.Models.ReclamacaoCliente", b =>
                {
                    ...
                    b.Property<string>("CanalRecebimento")
                        .IsRequired()
                        .HasMaxLength(100)
                    ...
                    b.ToTable("ReclamacoesClientes");
                });

            modelBuilder.Entity("SGQ.Web.Models.ReclamacaoClienteLote", b =>
                {
                    b.Property<int>("ReclamacaoClienteId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ReclamacaoClienteId", "LoteId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SGQ.Web.Models.ApplicationUser", null)
                        .WithMany()
